...
class ResBank extends Component {
  state = {
    data: [
      {
        id: "12345069",
      ...
      <div className="resbank">
        ...
        <section>
          ...
          <div class="tbl-content">
            <table cellpadding="0" cellspacing="0" border="0">
              <tbody>
                {this.state.data.map((ex, index) => {
                  const { sno, name, id, uploaded } = ex;
                  return (
                    <tr>
                      <td>{index + 1}</td>
                      <td>{id} </td>
